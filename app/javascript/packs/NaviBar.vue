<template>
  <header class="main-header">
    ...
    <a href="/" class="logo">
      ...
      <span class="logo-mini"><b>D</b>IS</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>DUC </b>SYS</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">{{$t('langs.language')}}</span>
            </a>
            <ul class="dropdown-menu">
              <li class="header">{{$t('langs.choose_lang')}}</li>
              <li class="langs" v-for="(lang, index) in langs" :key="index"><a @click.stop="change_lang(lang)">{{$t('langs.' + lang)}}</a></li>
            </ul>
          </li>
...
export default {
  ...
  methods: {
    change_lang(lang) {
      this.axios.post("/common/change_locale.json", {
        requestParam : {locale: lang},
        handleRes: response => {
            this.$i18n.locale = lang;
            // Validator.localize(lang.replace("-", "_"));
